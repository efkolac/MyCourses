...
INIT_STATEMENTS = [
    ...
    "CREATE TABLE IF NOT EXISTS COURSE_ROOM (roomname varchar(4), courseId Integer, PRIMARY KEY(roomname, courseId), FOREIGN KEY(roomname) REFERENCES CLASSROOM(name) ON DELETE CASCADE ON UPDATE CASCADE, FOREIGN KEY(courseId) REFERENCES COURSE(id) ON DELETE CASCADE ON UPDATE CASCADE)",
